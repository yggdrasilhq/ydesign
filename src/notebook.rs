...
pub const ASSETS: &[(&str, &[u8])] = &[
    ...
    (
        ...
        (
            "icon-arrow-up.svg",
            include_bytes!("../design/assets/icons/icon-arrow-up.svg"),
        ),
        (
            "icon-arrow-down.svg",
            include_bytes!("../design/assets/icons/icon-arrow-down.svg"),
        ),
        (
            "icon-arrow-left.svg",
            include_bytes!("../design/assets/icons/icon-arrow-left.svg"),
        ),
        (
            "icon-arrow-right.svg",
            include_bytes!("../design/assets/icons/icon-arrow-right.svg"),
        ),
        (
            "icon-chevron-up.svg",
            include_bytes!("../design/assets/icons/icon-chevron-up.svg"),
        ),
        (
            "icon-chevron-down.svg",
            include_bytes!("../design/assets/icons/icon-chevron-down.svg"),
        ),
        (
            "icon-chevron-left.svg",
            include_bytes!("../design/assets/icons/icon-chevron-left.svg"),
        ),
        (
            "icon-chevron-right.svg",
            include_bytes!("../design/assets/icons/icon-chevron-right.svg"),
        ),
        (
            "icon-x.svg",
            include_bytes!("../design/assets/icons/icon-x.svg"),
        ),
        (
            "icon-plus.svg",
            include_bytes!("../design/assets/icons/icon-plus.svg"),
        ),
        (
            "icon-minus.svg",
            include_bytes!("../design/assets/icons/icon-minus.svg"),
        ),
        (
            "icon-ellipsis.svg",
            include_bytes!("../design/assets/icons/icon-ellipsis.svg"),
        ),
        (
            "icon-ellipsis-vertical.svg",
            include_bytes!("../design/assets/icons/icon-ellipsis-vertical.svg"),
        ),
        (
            "icon-search.svg",
            include_bytes!("../design/assets/icons/icon-search.svg"),
        ),
        (
            "icon-square-pen.svg",
            include_bytes!("../design/assets/icons/icon-square-pen.svg"),
        ),
        (
            "icon-pencil.svg",
            include_bytes!("../design/assets/icons/icon-pencil.svg"),
        ),
        (
            "icon-copy.svg",
            include_bytes!("../design/assets/icons/icon-copy.svg"),
        ),
        (
            "icon-rotate-cw.svg",
            include_bytes!("../design/assets/icons/icon-rotate-cw.svg"),
        ),
        (
            "icon-git-branch.svg",
            include_bytes!("../design/assets/icons/icon-git-branch.svg"),
        ),
        (
            "icon-settings.svg",
            include_bytes!("../design/assets/icons/icon-settings.svg"),
        ),
        (
            "icon-share.svg",
            include_bytes!("../design/assets/icons/icon-share.svg"),
        ),
        (
            "icon-message-circle.svg",
            include_bytes!("../design/assets/icons/icon-message-circle.svg"),
        ),
        (
            "icon-hash.svg",
            include_bytes!("../design/assets/icons/icon-hash.svg"),
        ),
    (
        "ribbon-study.svg",
    ...
    (
        "vault-study.svg",
        include_bytes!("../design/assets/vault-study.svg"),
    ),
    (
        "catalogue-emd-reader.png",
        include_bytes!("../design/assets/catalogue-emd-reader.png"),
    ),
    (
        "catalogue-forms-rail.png",
        include_bytes!("../design/assets/catalogue-forms-rail.png"),
    ),
    (
        "catalogue-notebook-page.png",
        include_bytes!("../design/assets/catalogue-notebook-page.png"),
    ),
];
...
pub fn base_notebooks() -> Vec<Notebook> {
    ...
    let shipped: &[(&str, &str, &str, &str, &str)] = &[
        (
            ...
            include_str!("../design/notebooks/00-start-here.emd"),
        ),
        (
            "foundations",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/11-foundations.emd"),
        ),
        (
            "gallery",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/01-component-gallery.emd"),
        ),
        (
            "catalogue",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/08-design-catalogue.emd"),
        ),
        (
            "sidebars",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/02-sidebars.emd"),
        ),
        (
            "forms",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/03-forms-and-settings.emd"),
        ),
        (
            "motion",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/04-motion-and-feedback.emd"),
        ),
        (
            "emd",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/05-emd-and-notebooks.emd"),
        ),
        (
            "ribbons",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/09-ribbons.emd"),
        ),
        (
            "complex-sidebars",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/10-complex-sidebars.emd"),
        ),
        (
            "list-views",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/15-list-views.emd"),
        ),
        (
            "icons",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/14-icons.emd"),
        ),
        (
            "inheritance",
            MODE_GUIDE,
            ...
            include_str!("../design/Inheritance.md"),
        ),
        (
            "zcode-reversed",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/12-zcode-reversed-components.emd"),
        ),
        (
            "examples",
            MODE_EXAMPLES,
            ...
            include_str!("../design/notebooks/06-worked-examples.emd"),
        ),
        (
            "roadmap",
            MODE_GUIDE,
            ...
            include_str!("../design/notebooks/07-roadmap.emd"),
        ),
    ];
